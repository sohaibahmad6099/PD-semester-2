...
namespace Game
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int health = 100;
            int enemyHealth = 100;
            PrintMaze(maze, points, health, enemyHealth);
            while (true)
            {
                if (Keyboard.IsKeyPressed(Key.LeftArrow))
                {
                    movePlayerLeft(maze, ref points, ref health);
                    Console.WriteLine($"Score: {points} \t\t\t\t Health: {health} \t\t\t EnemyHealth: {enemyHealth}");
                    PrintMaze(maze, points, health, enemyHealth);
                    moveFire(maze, ref enemyHealth);
                    delFire(maze, ref enemyHealth);
                    enemyBullet(maze,ref health);
                    enemyFire(maze);
        ...
        static void PrintMaze(char[,] data, int points, int health,int enemyHealth)
        {
            Console.Clear();
            Console.WriteLine();
            Console.WriteLine();
        ...
        static void enemyBullet(char[,] data, ref int health)
        {
            for (int i = 0; i < data.GetLength(0); i++)
            {
                for (int j = 0; j < data.GetLength(1); j++)
